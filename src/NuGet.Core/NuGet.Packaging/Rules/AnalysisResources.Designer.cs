...
namespace NuGet.Packaging.Rules {
    ...
    public class AnalysisResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The folder &apos;{0}&apos; should include dots in its version number(s). This is required as of .NET 5.0. Please rename it to include the dots as needed (e.g. &apos;net50&apos; to &apos;net5.0&apos;)..
        /// </summary>
